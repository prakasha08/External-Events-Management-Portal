        ...
        <div class="main-content flex-grow p-4">
            ...
            <div class="table-div bg-white p-6 rounded shadow">
                ...
                <div class="flex justify-end mb-4">
                    <a href="{{ route('events_req.create') }}" class="bg-gray-700 text-white hover:bg-gray-500 px-4 py-2 rounded">
                    ...
                    <table class="min-w-full border-collapse">
                        <thead>
                            <tr class="bg-gray-200 text-black">
                                ...
                                <th class="border p-3 text-center">Event Name</th>k 
                        ...
                        @else
                            @foreach($eventsReq as $key => $eventReq)
                                <tr class="hover:bg-gray-100">
                                    ...
                                    <td class="border p-3 text-center">{{ $eventReq->ira_status }}</td>
                                </tr>
                            @endforeach
                        @endif
                        </tbody>
